...
async function loadProducts() {
    try {
        const res = await fetch(`${API_BASE_URL}/category/Fruite/`);
...
//==================================function  filter  search product===========================
...
//=======================================function  show(បង្ហាញ)product  to(ទៅ)  frotend======================
...
async function submitOrder() {
   ...
   //  =========ទៅ​ Home  page==============
    window.location.href = "/HTML/chackout.html"; 
}
